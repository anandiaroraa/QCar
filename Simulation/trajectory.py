...
def calc_lemniscate_course(scale=RADIUS, ds=DS, center_x=0.0, center_y=0.0, start_angle=0.0):
    """
    ...
    # Dense parametric sampling
    N_DENSE = 8000
    t = np.linspace(0.0, 2.0 * math.pi, N_DENSE, endpoint=False)
