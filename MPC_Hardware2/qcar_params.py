...
MAX_SPEED  = 0.2 #[m/s] not too fast
MIN_SPEED  = 0.065 #[m/s] #0.08-0.10 not too slow
...
MAX_ACCEL  = 0.5 # maximum acceleration [m/s^2] #not speed up too quickly
...
RADIUS     = 2.2  #[m] circle radius
LENGTH     = 2  #[m] straight line length
TARGET_SPEED = 0.07 #[m/s] target speed
MAX_TIME   = 140.0 #change this during experiments
DS         = 0.1
