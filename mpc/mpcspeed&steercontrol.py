...
def plot_car(x, y, yaw=0.0, radius=0.1, color="r"): #circular car
    ...
    #heading arrow for the dir of qcar
...
def get_straight_course(dl):
    ...
    cx, cy, cyaw, ck, s = rx, ry, ryaw, rk, s = calc_circle_course(radius=2.0, ds=0.1, center_x=0.0, center_y=0.0)
...
def get_straight_course2(dl):
    ...
    cx, cy, cyaw, ck, s = calc_circle_course(radius=2.0, ds=0.1, center_x=0.0, center_y=0.0)
...
def get_switch_back_course(dl):
    ...
    cx2, cy2, cyaw2, ck2, s2 = calc_circle_course(radius=2.0, ds=0.1, center_x=0.0, center_y=0.0)
