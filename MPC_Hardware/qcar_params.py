...
MAX_DSTEER = np.deg2rad(30.0) # maximum steering rate[rad/s]#not turn too suddenly
MAX_ACCEL  = 0.05 # maximum acceleration [m/s^2] #not speed up too quickly
DT         = 0.2  #[s] #time step #controller is running every 0.1 sec #10Hz
WB         = 0.256 #[m] #wheel base distance between the front axle and the rear axle
RADIUS     = 1.0   #[m] circle radius
LENGTH     = 1.0  #[m] straight line length
TARGET_SPEED = 0.09
