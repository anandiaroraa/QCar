...
MIN_SPEED  = 0.10 #[m/s] #0.08-0.10not too slow
MAX_STEER  = np.deg2rad(30.0) # 30 # maximum steering angle [rad] #0.436 #0.5236 not turn too much
MAX_DSTEER = np.deg2rad(50.0) # maximum steering rate[rad/s]#not turn too suddenly
MAX_ACCEL  = 0.15 # maximum acceleration [m/s^2] #not speed up too quickly
